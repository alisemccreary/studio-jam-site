...
# ---------------- CONTACT ----------------
ct = head("Contact | Studio Jam", "Get in touch with Studio Jam, a creative marketing studio. The first conversation is on the house.", "contact")
...
# ---------------- CLIENTS ----------------
cl = head("Clients | Studio Jam", "The businesses Studio Jam works with, on a map: Oxford and Baldwyn in Mississippi, Fayetteville in Arkansas, Charlotte in North Carolina, and a Colorado home base.", "clients")
