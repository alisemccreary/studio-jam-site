...
<section class="setlist">
  <p class="kicker">On the setlist</p>
  <ul class="setlist-names">
    <li><a href="https://www.marellemahjong.com/" target="_blank" rel="noopener">Marelle Mahjong</a></li>
    <li><a href="https://www.windowjoeoxford.com/" target="_blank" rel="noopener">Window Joe</a></li>
    <li><a href="https://jmservices.biz/" target="_blank" rel="noopener">JM Services</a></li>
    <li><a href="https://www.innatcarnallhall.com/restaurants-fayetteville-ar/lambeth-lounge-coffee-bar" target="_blank" rel="noopener">Lambeth Lounge</a></li>
    <li><a href="https://www.innatcarnallhall.com/restaurants-fayetteville-ar" target="_blank" rel="noopener">Ella&rsquo;s Table</a></li>
    <li><a href="https://instagram.com/kbridgers1" target="_blank" rel="noopener">Sober and Social</a></li>
  </ul>
  <a class="teaser-link" href="/clients">See the tour &#8594;</a>
</section>
...
SVC_EXTRA = {
  "01": ('', 'Recently for: The Living Room Nail Salon + Spa'),
  "02": ("", ""),
  "03": ('', 'Recently for: <a href="https://www.windowjoeoxford.com/" target="_blank" rel="noopener">Window Joe</a>, <a href="https://www.innatcarnallhall.com/restaurants-fayetteville-ar/lambeth-lounge-coffee-bar" target="_blank" rel="noopener">Lambeth Lounge</a>, <a href="https://www.innatcarnallhall.com/restaurants-fayetteville-ar" target="_blank" rel="noopener">Ella&rsquo;s Table</a>, <a href="https://www.marellemahjong.com/" target="_blank" rel="noopener">Marelle Mahjong</a>'),
  "04": ('', 'Recently for: <a href="https://instagram.com/kbridgers1" target="_blank" rel="noopener">Sober and Social</a>, <a href="https://jmservices.biz/" target="_blank" rel="noopener">JM Services</a>'),
}
rows = []
for n, name, p, items, good in SERVICES:
    lis = "".join(f"\n        <li>{i}</li>" for i in items)
