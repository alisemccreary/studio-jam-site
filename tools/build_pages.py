...
<section class="setlist">
  ...
  <ul class="setlist-names">
    <li>Marelle Mahjong</li>
    <li>Window Joe</li>
    <li>JM Services</li>
    <li>Lambeth Lounge</li>
    <li>Ella&rsquo;s Table</li>
    <li>Sober and Social</li>
  </ul>
  <a class="teaser-link" href="/clients">See who is where &#8594;</a>
</section>
...
SVC_EXTRA = {
  ...
  "02": ("alise-seated", ""),
  "03": ("alise-lookup", "Recently for: Window Joe, Lambeth Lounge, Ella&rsquo;s Table, Marelle Mahjong"),
  "04": ("alise-glasses", "Recently for: Sober and Social, JM Services"),
}
rows = []
for n, name, p, items, good in SERVICES:
    lis = "".join(f"\n        <li>{i}</li>" for i in items)
...
# ---------------- CLIENTS ----------------
cl = head("Clients on the Map | Studio Jam", "The businesses Studio Jam works with, on a map: Oxford and Baldwyn in Mississippi, Fayetteville in Arkansas, Charlotte in North Carolina, and a Colorado home base.", "clients")
cl += nav("clients") + ticker("Where We&rsquo;ve Jammed &#10039; Oxford &#10039; Baldwyn &#10039; Fayetteville &#10039; Charlotte &#10039; Colorado &#10039; Where We&rsquo;ve Jammed &#10039; Oxford &#10039; Baldwyn &#10039; Fayetteville &#10039; Charlotte &#10039; Colorado")
cl += page_hero("Clients", "Where we&rsquo;ve jammed",
                "Small businesses, shops, restaurants, and personal brands, each with its own story to tell. Here is who is on the map so far.",
                [("Become a pin", "/contact", "btn-blush btn-solid"), ("See the services", "/services", "btn-blush")], deco=("mascot-walk-pink.png", "walk"))
...
cl += cta_band("Let&rsquo;s jam", "Want your pin on the map?", "Tell me about your business, what&rsquo;s working, and what&rsquo;s not. The first conversation is on the house.", "Start the conversation") + footer()
