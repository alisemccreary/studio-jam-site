  ...
  <div class="split-grid">
    ...
    <div class="split-copy">
      ...
      <div class="tour-note">
        ...
        <p>Our clients are pinned across the South, from Fayetteville to Charlotte, with a home base in Colorado. See where the tour has played and who was on the bill.</p>
